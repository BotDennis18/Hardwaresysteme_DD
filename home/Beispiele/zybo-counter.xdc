## This file is a .xdc for the ZYBO Rev B board.
##
## It is adapted for the "counter" lab excercises at the
## Efficient Embedded Systems Group at the University of Applied
## Sciences Augsburg.
##
## 2018, Gundolf Kiefer <gundolf.kiefer@hs-augsburg.de>
##
...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { up }]; #IO_L19N_T3_VREF_35 Sch=SW0
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { down }];  #IO_L24P_T3_34 Sch=SW1
...
##Buttons
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L20N_T3_34 Sch=BTN0
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { cnt_out[0] }]; #IO_L23P_T3_35 Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { cnt_out[1] }]; #IO_L23N_T3_35 Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { cnt_out[2] }]; #IO_0_35=Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { cnt_out[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
